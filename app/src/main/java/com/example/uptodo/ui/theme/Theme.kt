...
fun UpTodoTheme(
    ...
    val orientation = when {
        windowsSizeClass.width.size > windowsSizeClass.height.size -> Orientation.Landscape
        else -> Orientation.Portrait
    }

    val sizeTheMatters = when (orientation) {
        Orientation.Portrait -> windowsSizeClass.width
        else -> windowsSizeClass.height
    }

    val dimensions = when (sizeTheMatters) {
    ...
    val typography = when (sizeTheMatters) {
...
object AppTheme {
    ...
    val orientation: Orientation
        @Composable
        get() = LocalAppOrientation.current
}
